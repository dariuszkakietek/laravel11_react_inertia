      ...
      header={
        <div className="flex justify-between items-center">
          ...
          <Link
            ...
            className="bg-emerald-500 py-1 px-3 text-white rounded shadow translation-all hover:bg-emerald-600"
          >
            Add new
          </Link>
        </div>
    ...
    >
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          {success && (
            <div className="bg-emerald-500 py-2 px-4 mb-8 text-white rounded">
              {success}
            </div>
          )}
                      ...
                      >
                        ...
                        <td className="px-3 py-3">
                          <Link
                            ...
                            className="font-medium text-blue-600 dark:text-blue-500 hover:inderline mx-1"
                          >
                            Edit
                          </Link>
                          ...
                          <Link
                            ...
                            className="font-medium text-red-600 dark:text-red-500 hover:inderline mx-1"
                          >
                            Delete
                          </Link>
                        </td>
